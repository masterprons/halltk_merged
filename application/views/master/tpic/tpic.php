    ...
    <body>
        <header class="pad-tb-0px-lr-20px box-shadow-header">
            <div class="logo pad-t-5px">
                <img src="<?php echo site_url(); echo $tpicImages; ?>halltk-logo-new.png" alt="Tpic Logo">
            </div>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo site_url();?>"><h2>HALLTK</h2></a></li>
                    <li><a href="<?php echo site_url();?>tpic"><h2>TPIC</h2></a></li>
                    <li><a href="<?php echo site_url()?>prcity"><h2>PRCITY</h2></a></li>
                </ul>
            </nav>
        </header>
