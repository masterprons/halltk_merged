...
<html lang="eng-us">
    <head>
        ...
        <!--|| Style sheet ||-->
        <link href="<?php echo site_url(); ?>assets/master/tpic/css/centuryHot.css" rel="stylesheet" type="text/css" media="all">
    ...
    <?php
        ...
        $thumbpath = "assets/master/tpic/images/beach_babes1/thumbs/";
        $URL= [
                '1' => 'beach-babes1/1',
                '2' => 'beach-babes1/2',
                '3' => 'beach-babes1/3',
